...
<head>
    ...
    <link name="favicon" type="image/x-icon" href="<?php echo base_url().'assets/fab.png' ?>" rel="shortcut icon" />
    <title></title>
        ...
        <section class="gray-bg height-100vh d-flex align-items-center page-section-ptb ">
            <div class="container">
                <div class="row no-gutters justify-content-center">
                    <div class="col-lg-4 col-md-6 login-fancy-bg bg-overlay-black-0 mobile_view" style="background: url(assets/backend/login/black.jpg);">
                        <div class="login-fancy pos-r d-flex">
                            <div class="text-center w-100 align-self-center">
                                <img src="<?php echo base_url().'assets/global/ds.png'; ?>" height="40" />
