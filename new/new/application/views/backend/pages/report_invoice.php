...
<head>
    ...
    <title>Print</title>
	<link rel="shortcut icon" href="<?php echo base_url();?>assets/global/fab.png">
	<!-- third party css -->
	            ...
	            <div class="card-body">
	            	<div class="row">
						<div class="col-sm-12 col-md-6 col-lg-6 pt-3 pb-2">
							<img src="<?php echo base_url();?>assets/global/ds.png" height="30px;" />
						</div>
						<div class="col-sm-12 col-md-6 col-lg-6 pt-3 pb-2">
	            	...
	            	<table width="100%">
						    ...
						    ?>
									...
									<tr>
										<td>
											<div class="mt-0 pt-0 float-top"><b><?php echo get_phrase('customer_name'); ?> : <?php echo $user['name']; ?></b></div><br>
										...
										<td>
											...
											<div class="w-50 float-left">
												...
												<div class="badge badge-light badge-lg"><?php echo $subscription['payment_method']; ?></div>
											</div>
										</td>
