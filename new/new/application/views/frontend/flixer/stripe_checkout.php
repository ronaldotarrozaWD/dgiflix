...
<html lang="en">
    <head>
        ...
        <link href="<?php echo base_url('assets/frontend/flixer/stripe.css');?>"
            rel="stylesheet">
        <link name="favicon" type="image/x-icon" href="<?php echo base_url('assets/global/fab.png');?>" rel="shortcut icon" />
    </head>
    <body>
...
<!--required for getting the stripe token-->
          ...
          <img src="<?php echo base_url('assets/global/ds.png'); ?>" width="25%;"
             style="opacity: 0.05;">
