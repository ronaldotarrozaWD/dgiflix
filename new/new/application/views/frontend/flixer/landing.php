<!-- TOP LANDING SECTION -->
<div style="height:93vh;width:100%;background-image: url(<?php echo base_url().'assets/frontend/flixer/images/ann.gif';?>)">
	<!-- logo -->
	<div style="float: left;">
		<a href="<?php echo base_url();?>index.php?home">
		<img src="<?php echo base_url();?>/assets/global/ds.png" style="margin: 18px 18px; width: 160px;" />
		</a>
	</div>
							...
							<tbody>
								...
								<tr>
									...
									<?php
										...
										foreach ($plans as $row):
										?>
									<td align="center">PHP <?php echo $row['price'];?></td>
									<?php endforeach;?>
								</tr>
								<tr>
