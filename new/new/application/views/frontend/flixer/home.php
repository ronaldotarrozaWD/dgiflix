...
<?php
	...
	?>
<!-- Include the Helvetica Neue font -->
<style>
...
<div style="background-image: url(<?php echo $this->crud_model->get_poster_url('movie' , $featured_movie->movie_id);?>); background-size:cover; width: 100%;">
    <div class="mobile_responsive" style="font-weight: bold; color: #fff;">
        <h1 class="mobile_responsive_text_bold" style="color: #fff; font-family: 'Netflix Sans', Arial, sans-serif;"><?php echo $featured_movie->title;?></h1>
        <h5 class="mobile_responsive_sort_description" style="color: #fff; max-width: 900px; font-family: 'Netflix Sans', Arial, sans-serif;"><?php echo $featured_movie->description_short;?></h5>
