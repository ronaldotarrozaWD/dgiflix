...
<!-- TOP LANDING SECTION -->
<div style="height:93vh;  background-position: center;  background-size: cover; width:100%; clear: both; background-image: url(<?php echo base_url().'assets/frontend/'.$selected_theme;?>/images/annn.gif)">
	<!-- logo -->
	<div style="float: left;">
		<a href="<?php echo base_url();?>index.php?home">
		<img src="<?php echo base_url();?>/assets/global/ds.png" style="margin: 18px 40px; height: 50px;" />
		</a>
	</div>
	<div class="row">
